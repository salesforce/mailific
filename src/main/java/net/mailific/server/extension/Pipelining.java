...
/**
 * Adds support for PIPELINING (RFC1854).
 *
 * <p>The base server already complies with the Pipelining rfc, so this extension really just
 * advertises that pipelining is acceptable.
 *
 * @author jhumphreys
 * @since 1.0.0
 */
