...
public class SmtpSessionInitializer extends ChannelInitializer<SocketChannel> {
  ...
  public SmtpSessionInitializer(
      SmtpSessionFactory sessionFactory, SslContext sslContext, SmtpEventLogger logger) {
  ...
  protected void initChannel(SocketChannel ch) throws Exception {
    logger.trace("INIT_CHANNEL", null, "Initializing channel pipeline");
    ...
    pipeline.addLast("smtp", new SmtpServerHandler(sslContext, logger));
  }
}
