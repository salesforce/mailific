...
public class SmtpSessionFactoryImp implements SmtpSessionFactory {
  ...
  private SmtpEventLogger logger;

  public SmtpSessionFactoryImp(
      LineConsumer lineConsumer, Collection<Extension> extensions, SmtpEventLogger logger) {
  ...
  public SmtpSession newSmtpSession(InetSocketAddress remoteAddress) {
    return new SmtpSessionImp(
        remoteAddress,
        this.lineConsumer,
        Collections.unmodifiableCollection(this.extensions),
        this.logger);
  }
}
