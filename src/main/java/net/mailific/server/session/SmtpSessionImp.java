...
public class SmtpSessionImp implements SmtpSession {
  ...
  private SmtpEventLogger eventLogger;
  ...
  public Reply completeMailObject() {
    if (currentMailObject == null) {
      // Should never occur
      getEventLogger().error("COMPLETE_MISSING_MAIL", null, "MailObject is null when completed.");
  ...
  @Override
  public SmtpEventLogger getEventLogger() {
    return eventLogger;
  }
}
